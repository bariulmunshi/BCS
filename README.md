...
- কম্পিউটার
   - [Slide: কম্পিউটার (Computer Peripherals): কি-বোর্ড (Keyboard), মাউস (Mouse), ওসিআর (OCR) ইত্যাদি](https://www.canva.com/design/DAGtikSQ40g/QKiF4k0gXvvc1XDqdwPXBA/edit?utm_content=DAGtikSQ40g&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton)
...
- Phase-5 Make website with ES6 (including DOM manipulation) & API
  - [project-12](https://github.com/bariulmunshi/MERN-Project-12/tree/main) with ES6 & API
# Website making idea 
